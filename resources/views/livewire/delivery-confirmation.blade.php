<div>
    ...
    <h2 class="text-2xl font-bold mb-4">{{ __('Confirm Delivery') }}</h2>
    <form wire:submit.prevent="confirmDelivery" class="space-y-4">
        <div>
            <label for="deliveryCode" class="block text-sm font-medium text-gray-700">{{ __('Delivery Code') }}</label>
        ...
        <div>
            <label for="proofOfDelivery" class="block text-sm font-medium text-gray-700">{{ __('Proof of Delivery (Optional)') }}</label>
